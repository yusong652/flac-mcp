"""Data models for FLAC SDK documentation system.
...
class SearchResult:
    ...
    Attributes:
        api_name: Internal API name (e.g., "Contact.gap" for zone methods)
    ...
    Examples:
        >>> SearchResult("itasca.zone.create", 999, SearchStrategy.PATH, None)
        >>> SearchResult("Contact.gap", 999, SearchStrategy.PATH,
        ...              {"zone_type": "ZoneZoneContact"})
    """
...
class APIDocumentation:
    ...
    This model represents the complete documentation for a FLAC Python SDK API,
    parsed from JSON documentation files.

    Attributes:
        api_name: Full API name (e.g., "itasca.zone.create")
        ...
        fallback_commands: Alternative FLAC commands to use instead (optional)
